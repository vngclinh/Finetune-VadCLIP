...
parser = argparse.ArgumentParser(description="Description-guided class semantic fine-tuning on UCF-Crime")
...
parser.add_argument("--lambda-sem", default=0.05, type=float)
parser.add_argument("--semantic-alpha", default=0.2, type=float)
parser.add_argument("--semantic-temperature", default=0.07, type=float)
parser.add_argument("--video-logit-pooling", default="topk", choices=["mean", "topk", "weighted"])
...
parser.add_argument("--output-model-path", default="model/model_ucf_class_semantic.pth")
parser.add_argument("--checkpoint-path", default="model/checkpoint_class_semantic.pth")
...
parser.add_argument("--save-cur-path", default="model/model_cur_class_semantic.pth")
parser.add_argument("--epoch-checkpoint-dir", default="model/epoch_checkpoints_class_semantic")
...
parser.add_argument("--cache-semantic-targets", default=True, type=str2bool)
